...
class financepayment {
  ...
  function addOtherOptions($plans)
  {
    ...
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Prefix', 'MODULE_PAYMENT_FINANCEPAYMENT_PREFIX', 'Finance From', 'Prefix of the Finance payment module', '6', '0', now())");
